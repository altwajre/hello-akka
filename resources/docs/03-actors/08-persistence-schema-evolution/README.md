...
- We recommend something like [Google Protocol Buffers](https://developers.google.com/protocol-buffers) or [Apache Thrift](https://thrift.apache.org/).
...
- however much of it you will find is common infrastructure code that can be either
- provided by an external library (for promotion management) 
...
- from the data model classes 
    - (which very often may be less user-friendly yet highly optimised for throughput) 
- and schema evolution 
    - (like the classes generated by Protobuf for example), 
