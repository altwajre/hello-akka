...
class TripLoader extends LagomApplicationLoader {
  ...
  LagomApplication = new TripApplication(context) {
...
abstract class TripApplication(context: LagomApplicationContext) extends LagomApplication(context) with CassandraPersistenceComponents with AhcWSComponents {
